...
const releaseNotes: ReleaseNote[] = [
    {
        ...
        date: '2026年2月23日',
        improvements: [
            '404ページのアスキーアートを縦に読みやすい構成へ変更し、`404` と `NOT FOUND` を判別しやすくしました。',
            '猫のアスキーアートを `404 NOT FOUND` の1行下に配置するように調整しました。',
        ],
        fixes: [
            '404アスキーアートが横長で数字を認識しづらい問題を修正しました。',
            '猫アスキーアートの配置が要望どおりの行位置になっていない問題を修正しました。',
        ],
    },
    {
        version: '1.12.3',
        date: '2026年2月23日',
        improvements: [
            '404ページの先頭を「404 NOT FOUND」のアスキーアート表示に変更し、下段に猫のアスキーアートを配置しました。',
        ],
        fixes: [
            '通常文言を `404 NOT FOUND` に置き換えていた表示を元に戻し、「404 - ページが見つかりませんでした。」を再表示するよう修正しました。',
            '404アスキーアートの横幅を調整し、表示ずれが起きにくいようにしました。',
        ],
    },
    {
        version: '1.12.2',
        date: '2026年2月23日',
        improvements: [
            '404ページの表示文言を `404 NOT FOUND` に統一し、エラー状態を明確にしました。',
        ],
        fixes: [
            '404アスキーアートが行ごとに中央寄せされて見た目がずれる問題を修正し、全体を崩さず中央表示されるようにしました。',
        ],
    },
    {
        version: '1.12.1',
        date: '2026年2月23日',
        improvements: [
            '404ページにアスキーアートの「404」と猫を表示し、誤ったURLへアクセスした際に状態を視覚的に把握しやすくしました。',
        ],
        fixes: [
            '404ページがテキストのみで味気なく、エラー状態だと直感的に分かりづらい問題を改善しました。',
        ],
    },
    {
        version: '1.12.0',
        date: '2026年2月23日',
        improvements: [
            '存在しないURLへアクセスした場合に、専用の404ページを表示するようにしました。',
            '管理者以外には `/admin` ルート自体を公開せず、URLを直接開いた場合も通常の404と同じ表示に統一しました。',
        ],
        fixes: [
            '非管理者が管理コンソールのURLへアクセスした際に挙動が通常画面と異なって見える問題を解消しました。',
            '不正なURLアクセス時の案内が統一されず分かりにくい問題を修正しました。',
        ],
    },
    {
        version: '1.11.2',
        date: '2026年2月23日',
        improvements: [
            '非管理者が `/admin` にアクセスした場合はトップ画面へ遷移するようにし、管理コンソールの存在を推測しにくくしました。',
        ],
        fixes: [
            '管理専用APIを非管理者から呼び出した際に 404 を返すように調整し、エンドポイントの露出を抑えました。',
        ],
    },
    {
        version: '1.11.1',
        date: '2026年2月23日',
        improvements: [
            'ユーザー削除ダイアログの外枠カラーを、削除ボタンと同じ赤色トーンに統一しました。',
        ],
        fixes: [
            '削除ダイアログの枠色だけ他の削除導線と色味が揃っていない問題を修正しました。',
        ],
    },
    {
        version: '1.11.0',
        date: '2026年2月23日',
        improvements: [
            'ユーザー削除モーダルに確認用テキスト入力を追加し、対象ユーザー名と一致しない限り「削除する」を押せないようにしました。',
            'ユーザー削除完了時の案内をブラウザダイアログではなく、管理画面上部の通知表示で確認できるようにしました。',
        ],
        fixes: [
            '誤って削除操作を実行しやすい問題を改善し、入力一致による実行ガードを追加しました。',
            '削除後の通知がダイアログ依存で操作フローを中断してしまう問題を改善しました。',
        ],
    },
    {
        version: '1.10.4',
        date: '2026年2月23日',
        improvements: [
            'ユーザー一覧の「ユーザー削除」ボタンと削除モーダルの見出しを、削除実行ボタンと同じ赤トーンに統一しました。',
        ],
        fixes: [
            '削除関連の赤色が箇所ごとに異なって見える問題を調整し、危険操作の視認性を一貫化しました。',
        ],
    },
    {
        version: '1.10.3',
        date: '2026年2月23日',
        improvements: [
            'ユーザー削除モーダルの「削除する」ボタンを赤グラデーションで強調し、危険操作を即座に識別できるようにしました。',
        ],
        fixes: [
            '削除実行ボタンの色が周囲の操作ボタンと見分けにくい問題を調整しました。',
        ],
    },
    {
        version: '1.10.2',
        date: '2026年2月23日',
        improvements: [
            'ユーザー削除モーダルの配色をダークトーンに調整し、警告表示と削除操作の判別性を高めました。',
        ],
        fixes: [
            '削除モーダル外枠の角がはみ出して見える問題を修正し、ダイアログの角丸と枠線が一致するようにしました。',
            '白地の警告ボックスで視認性が下がる問題を修正し、暗色背景でも読みやすい色使いに変更しました。',
        ],
    },
    {
        version: '1.10.1',
        date: '2026年2月23日',
        improvements: [
            'ユーザー削除操作をより判別しやすくするため、削除ボタンと削除確認モーダルを赤系で強調表示するようにしました。',
        ],
        fixes: [
            'ユーザー削除確認の警告表示が目立ちにくい問題を調整し、誤操作に気づきやすい配色へ改善しました。',
        ],
    },
    {
        version: '1.10.0',
        date: '2026年2月23日',
        improvements: [
            '管理コンソールに登録ユーザー一覧テーブルを追加し、ID・ユーザー名・権限・作成日時・有効セッション数を確認できるようにしました。',
            '管理コンソールからユーザーごとのパスワード再設定を実行できるようにしました。',
            '管理コンソールから不要ユーザーを削除できるようにしました（関連データも合わせて削除）。',
        ],
        fixes: [
            '管理操作APIを管理者権限チェック付きで追加し、非管理者がユーザー一覧/パスワード更新/削除を実行できないようにしました。',
            'ユーザー削除時に自分自身を削除できないよう制御し、管理者の誤操作でアクセス不能になるリスクを軽減しました。',
        ],
    },
    {
        version: '1.9.0',
