...
const releaseNotes: ReleaseNote[] = [
    {
        ...
        date: '2026年2月23日',
        improvements: [
            '管理コンソール画面を追加し、ユーザー数・問題数・復習件数などの運用メトリクスを一覧で確認できるようにしました。',
            '管理者ユーザーにのみアプリランチャーから管理コンソールへの導線を表示するようにしました。',
            '管理者の判定をサーバー側の許可リスト（環境変数）で行えるようにし、運用時にアクセス対象を明示的に管理できるようにしました。',
        ],
        fixes: [
            '管理者権限のないユーザーがURLを直接開いた場合でも、APIで必ず403拒否されるようにして情報取得を防止しました。',
            '管理画面のブックマーク/再読み込み時に正しく表示できるよう、`/admin` のルーティング設定を追加しました。',
        ],
    },
    {
        version: '1.8.17',
